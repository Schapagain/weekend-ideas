export default {
  ...
  activity: {
    ...
    // activity: "Learn Express.js or some other thing",
    activity: "Learn Express.js or some other thing or maybe yet another thing",
    // activity:
    // "Learn Express.js or some other thing or maybe yet another thing and yet another another thing",
    accessibility: 0.25,
    type: "education",
    participants: 1,
    price: 0.1,
